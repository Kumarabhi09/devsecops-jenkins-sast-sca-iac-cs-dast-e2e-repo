pipeline {
  ...
  stages {
    ...
    stage('RunDASTUsingZAP') {
      steps {
        bat("D:\Softwares\ZAP_2.16.0_Crossplatform\ZAP_2.16.0\\zap.sh -port 9393 -cmd -quickurl https://www.example.com -quickprogress -quickout D:\Softwares\ZAP_2.16.0_Crossplatform\ZAP_2.16.0\\Output.html")
      }
    }
